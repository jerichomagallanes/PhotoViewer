...
class GetSearchPhotosUseCaseTest {
    ...
    @Test
    fun `Get Search Photos, repository returns search photos`() = testDispatcher.runBlockingTest {
    ...
    @Test
    fun `Get Search Photos, repository returns empty list returns success`() = testDispatcher.runBlockingTest {
    ...
    @Test
    fun `Get Search Photos, repository throws generic exception returns error`() = testDispatcher.runBlockingTest {
    ...
    @Test
    fun `Get Search Photos, query returns 400 error`() = testDispatcher.runBlockingTest {
        val query = ""
    ...
    @Test
    fun `Get Search Photos, empty query returns invalid JSON`() = testDispatcher.runBlockingTest {
